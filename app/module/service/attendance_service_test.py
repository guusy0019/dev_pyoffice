...
class TestAttendanceService(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.attendance_path = "C:\\Users\\matty\\doc\\2024（sample）出勤簿.xlsx"
    ...
    def test_get_initial_attendance_path(self):
        initial_path = self.attendance_service.get_initial_attendance_path()
        self.assertEqual(initial_path, self.attendance_path)
